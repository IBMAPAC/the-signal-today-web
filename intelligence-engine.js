        ...
        for (let attempt = 1; attempt <= MAX_RETRIES; attempt++) {
            try {
                ...
                try {
                    ...
                    console.error('Repaired JSON tail (last 100 chars):', jsonStr.slice(-100));
